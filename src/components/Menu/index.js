            ...
            <div className="text-center justify-content-center align-items-center d-flex h-75">
              <div>
                <h1 className="font-hero-title">
                  ...
                  <span className="font-hero-title-y">{  hero?.titleP2.substring(0,15).includes('public') ?  <Image src={`${baseURL}/${hero?.titleP2.substring(15,hero?.titleP2.length)}`} roundedCircle 
