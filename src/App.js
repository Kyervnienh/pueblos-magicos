  ...
  return (
    <Router>
      <Switch>
        ...
        <Route path="/dashboard/addTown" component={isLogged && isAdmin ? AddTown : NotFoundPage} exact></Route>
        <Route path="/dashboard/editTown" component={isLogged && isAdmin ? EditTown : NotFoundPage} exact></Route>
